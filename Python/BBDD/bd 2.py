...
'''
AUTO
cursor.execute (" CREATE TABLE PROD2 (ID INTERGER PRIMARY KEY AUTOINCREMENT  ,NOMBREART VARCHAR (20) UNIQUE, PRECIO INTGER, SECCION VARCHAR (10)) ") 
prodos =[
 ...
 UPDATE :
 cursor.execute ("UPDATE PROD2 SET PRECIO = 35 WHERE NOMBREART P= 'pelota")
 DELETE 
cursor.execute ("DELETE FROM PROD2 WHERE ID = 5 ")
